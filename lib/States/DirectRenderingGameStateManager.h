...
#ifndef PONG_DIRECTRENDERINGGAMESTATEMANAGER_H
#define PONG_DIRECTRENDERINGGAMESTATEMANAGER_H
...
namespace States {
    ...
    ///   </para>
    /// </remarks>
    class DirectRenderingGameStateManager : public GameStateManager,
    ...
    public: DirectRenderingGameStateManager(unsigned int windowWidth = 1024, unsigned int windowHeight = 768);
        ...
        /// </summary>
    public: virtual ~DirectRenderingGameStateManager();
...
#endif //PONG_DIRECTRENDERINGGAMESTATEMANAGER_H
